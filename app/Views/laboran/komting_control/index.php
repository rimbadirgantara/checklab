		    ...
		    <section class="content">
		      ...
		      <div class="card card-solid">
		        ...
		        <div class="card-body pb-0">
		          <a href="<?= base_url('/kom/tmbhkomting'); ?>" class="btn btn-success btn-sm mb-3">Tambah User <i class="fas fa-users"></i></a>
		          <div class="row">
			              ...
			              <div class="card bg-light d-flex flex-fill">
			                ...
			                <div class="card-body pt-0">
			                  <div class="row">
			                    <div class="col-7">
			                      ...
			                      <p class="text-muted text-sm"><b>Prodi </b> [ <?= $a['prodi']; ?> ] </p>
			                    </div>
			                ...
			                <div class="card-footer">
			                  <div class="text-right">
			                    <a href="<?= base_url('/kom/' . $a['username'] . '/info_komting'); ?>" class="btn btn-sm btn-info">
			                      <i class="fas fa-info"></i>
			                    </a>
			                    <form action="<?= base_url('/kom/' . $a['id'] . '/hapus_komting'); ?>" method="post" class="d-inline">
		                        <?= csrf_field(); ?>

                  ...
                  <tbody>
                    ...
                    foreach ($data_reservasi as $a): ?>
                      <tr class="text-center">
                        ...
                        <td>
                          <a href="<?= base_url('/labre/'.$a['id'].'/detail/reservasi'); ?>" title="Info" class="btn btn-info btn-sm"><i class="fas fa-info-circle"></i></a>

                          <form action="<?= base_url('/labre/'.$a['id']); ?>" method="post">
                            <?= csrf_field(); ?>

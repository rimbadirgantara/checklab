            ...
            <div class="row">
                ...
                <div class="card card-primary card-outline">
                  <div class="card-body box-profile">
                    ...
                    <ul class="list-group list-group-unbordered mb-3">
                      ...
                      <li class="list-group-item">
                        <b>No Laboran</b> <a class="float-right"><?= $data_profile['no_laboran']; ?></a>
                      </li>
                      <li class="list-group-item">
              ...
              <div class="col-md-8">
                  <div class="card card-primary">
                    ...
                    <!-- /.card-header -->
                    <form class="form-horizontal" method="post" action="<?= base_url(); ?>/profiles_edit_laboran/<?= $data_profile['username']; ?>">
                      <div class="card-body">
                        ...
                        <div class="form-group row">
                          <label for="no_laboran" class="col-sm-2 col-form-label">NIM</label>
                          <div class="col-sm-10">
                            <input type="text" class="form-control <?= ($valid->hasError('no_laboran')) ? 'is-invalid' : ''; ?>" name="no_laboran" id="no_laboran" value="<?= (old('no_laboran')) ? old('no_laboran') : $data_profile['no_laboran']; ?>">
                            <div class="invalid-feedback">
                              <?= $valid->getError('no_laboran'); ?>
                            </div>
                          </div>
                        </div>
